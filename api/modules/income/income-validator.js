...
const model = require('./income-model');
...
const categoryService = require('../income-category/income-category-service');
...
const createValidation = async item => {
  ...
  const accountResult = await accountService.checkMaximumBalance(
    item.account,
    item.amount
  );
